...
import { getAPIResponse, type ExtendedChatHttpOptions } from '../core/http/index.js';
...
export class ChatController implements ReactiveController {
  ...
  async generateAnswer(
    ...
    httpOptions: ChatHttpOptions & { chatId?: string | number | null; personalityId?: string | number | null },
  ) {
